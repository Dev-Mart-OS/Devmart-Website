        ...
        <article>
          <div className="container mx-auto p-5 w-4/5">
            <div className="flex flex-auto items-center">
              <h1 className="text-6xl text-left font-extrabold text-gray-900 sm:text-4xl sm:m-1 lg:m-2 lg:text-6xl">Posts</h1>
            </div>
...
export async function getStaticProps() {
    ...
    const fullPosts = await (await getAllPosts())
    const allPosts = fullPosts.slice(0, 2)
    return {
      props: {
        fullPosts: fullPosts,
        posts: allPosts,
